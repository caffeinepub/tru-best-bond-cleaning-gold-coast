...
export class Backend implements backendInterface {
    ...
    async submitEnquiry(arg0: string, arg1: string, arg2: string, arg3: string, arg4: ServiceType, arg5: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitEnquiry(arg0, arg1, arg2, arg3, to_candid_ServiceType_n6(this._uploadFile, this._downloadFile, arg4), arg5);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_variant_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "bondCleaning" in value ? {
        __kind__: "bondCleaning",
        bondCleaning: value.bondCleaning
    } : "windowCleaning" in value ? {
        __kind__: "windowCleaning",
        windowCleaning: value.windowCleaning
    } : "other" in value ? {
        __kind__: "other",
        other: value.other
    } : "pestControl" in value ? {
        __kind__: "pestControl",
        pestControl: value.pestControl
    } : "carpetCleaning" in value ? {
        __kind__: "carpetCleaning",
        carpetCleaning: value.carpetCleaning
    } : value;
}
...
function to_candid_variant_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return value.__kind__ === "bondCleaning" ? {
        bondCleaning: value.bondCleaning
    } : value.__kind__ === "windowCleaning" ? {
        windowCleaning: value.windowCleaning
    } : value.__kind__ === "other" ? {
        other: value.other
    } : value.__kind__ === "pestControl" ? {
        pestControl: value.pestControl
    } : value.__kind__ === "carpetCleaning" ? {
        carpetCleaning: value.carpetCleaning
    } : value;
}
